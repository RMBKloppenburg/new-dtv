		...
		<div class="templatemo-content-container">
			<div class="templatemo-flex-row flex-content-row">
				...
				<div class="templatemo-content-widget white-bg col-1 text-center">
					...
					<img src="BackEndassets/images/bicycle.jpg" alt="Bicycle" class="img-circle img-thumbnail">
				</div>
					...
					<div class="templatemo-content-widget orange-bg">
						...
						<div class="media">
							<div class="media-left">
								<a href="#">
									<img class="media-object img-circle" src="BackEndassets/images/sunset.jpg" alt="Sunset">
								</a>
							</div>
...
<!-- JS -->
<script src="BackEndassets/js/jquery-1.11.2.min.js"></script>      <!-- jQuery -->
<script src="BackEndassets/js/jquery-migrate-1.2.1.min.js"></script> <!--  jQuery Migrate Plugin -->
